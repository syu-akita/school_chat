...
| ---------------------------------------------- | -------------------------- |
| 先生から子供が手紙をもらっているはずなのに持って帰ってこない                    | メッセージ送信機能に画像を送信できるようにする                    |
| 学校側に気軽に意見を投稿したい                   | 目安箱を作成し気軽に意見を投稿できるようにする                    |
| 連絡網を回したいけど仕事が忙しくて電話をする暇ない                    | メッセージを送れるようにする。非同期で送信できるようにする。                    |


# :notebook_with_decorative_cover: 機能一覧
| 機能               | 概要               |
| ----------------- | ------------------ |
| ユーザー管理機能 | 新規登録・ログイン・ログアウトが可能 |
| ルーム作成機能 | ルームの作成ができる |
| メッセージ投稿機能 | メッセージの送信ができる |
| 画像投稿機能 | 画像の投稿ができる |
| 目安箱投稿機能 | 目安箱に意見を投稿できる |
| 目安箱表示機能 | 送られてきた内容を確認できる |
